                    ...
                    <div class="skill-card-modern" data-category="{{ skill.category }}">
                        <div class="skill-header">
                            <div class="skill-level-indicator">
                                <div class="level-circle" data-level="{{ skill.level }}">
                                    <span class="level-percentage">{{ skill.level }}%</span>
                                </div>
                                <div class="experience-badge">{{ skill.years_experience }} ans</div>
                            </div>
                        </div>
                        ...
                        <div class="skill-content">
                            ...
                            <div class="skill-achievements">
                                <div class="achievement-item">
                                    ...
                                    <span class="achievement-text">{{ skill.achievements }}</span>
                                </div>
                            </div>
                            {% endif %}
                            ...
                            <div class="skill-impact">
                                <div class="impact-item">
                                    <svg class="impact-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <polygon points="13,2 3,14 12,14 11,22 21,10 12,10"/>
                                    </svg>
                                    <span class="impact-text">{{ skill.impact }}</span>
                                </div>
                            </div>
                            {% endif %}
                        </div>
