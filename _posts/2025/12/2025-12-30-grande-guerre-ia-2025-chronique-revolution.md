...
**Sur SWE-bench Verified** (tâches de codage réelles extraites de GitHub) :
...
**Janvier 2025 - Lancement de DeepSeek R1 :**
Le modèle prétendait rivaliser avec les meilleurs modèles américains tout en coûtant une fraction du prix et en nécessitant beaucoup moins de puissance de calcul.
...
Plutôt que de développer ses propres modèles de fondation (bien qu'investissant massivement dans OpenAI), Microsoft se concentrait sur l'**application pratique de l'IA dans les workflows professionnels quotidiens**.
...
**Le constat positif :**
Les organisations rapportant Microsoft 365 comme "facile à supporter" étaient **9 fois plus susceptibles** d'extraire une valeur significative de Copilot (26% vs 3%).
...
**Un constat qui bouleverse les stéréotypes générationnels :**
Un employé de la **Génération X** ayant reçu une formation en IA obtenait de meilleurs gains de productivité qu'un employé de la **Génération Z** non formé.
...
3. Protection contre la discrimination algorithmique
4. Explication des décisions automatisées
5. Possibilité de choisir des alternatives humaines
...
| **Google** | Puissance de l'intégration écosystémique | Gemini 3, déploiement Chrome/Search/Workspace |
...
1. **Passage du pilote au déploiement à grande échelle** pour de nombreuses organisations
2. **Différenciation compétitive** par maîtrise de l'IA (séparation définitive)
3. **Évolution rapide des capacités** : vidéo native, interactions plus riches
4. **Intégration IA-robotique** : IA dans le monde physique
5. **Généralisation des agents IA autonomes** : tâches complexes de bout en bout
6. **Débats intensifiés sur l'AGI** : délais resserrés
7. **Mise en application effective de l'AI Act européen** : conformité obligatoire
