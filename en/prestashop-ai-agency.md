...
<section class="section-creator" style="padding: 6rem 0 4rem; background: #0a0a0f; margin: 0;">
    <div class="container-creator">
        <div class="hero-content" style="text-align: center; max-width: 800px; margin: 0 auto;">
            <p class="hero-subtitle" style="text-transform: uppercase; letter-spacing: 2px; font-size: 0.85rem; color: #4775ff; margin-bottom: 1rem;">Squad PrestaShop · Specialized AI Agents</p>
            <h1 class="hero-title" style="font-size: 2.5rem; margin-bottom: 1.5rem;">
                <span class="hero-title-main">A Team of Experts Available 24/7</span>
            </h1>
            <p class="hero-description" style="font-size: 1.1rem; line-height: 1.7; margin-bottom: 2rem;">
                Each agent specializes in a specific area of PrestaShop module development. Together, they cover the entire lifecycle of a module — from functional spec to production deployment.
            </p>
...
<section class="section-creator" style="padding: 3rem 0 4rem; background: #0d0d14; margin: 0;">
    <div class="container-creator">
        <div class="section-header-creator" style="text-align: center; margin-bottom: 3rem;">
            ...
            <h2 class="section-title-creator" style="font-size: 1.75rem;">Design, Operations, Packaging</h2>
        </div>
        ...
        <div class="ecosystem-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;">
            ...
            <div class="ecosystem-card" style="background: #0f0f14; border: 1px solid #1f1f2e; border-radius: 12px; padding: 1.5rem; transition: all 0.3s ease;">
                ...
                <p style="color: #9ca3af; font-size: 0.9rem; line-height: 1.5; margin-bottom: 1rem;">PS 8/9 module architecture. Symfony patterns, CQRS hooks, Command Bus. From spec to implementation.</p>
            ...
            <div class="ecosystem-card" style="background: #0f0f14; border: 1px solid #1f1f2e; border-radius: 12px; padding: 1.5rem; transition: all 0.3s ease;">
                ...
                <p style="color: #9ca3af; font-size: 0.9rem; line-height: 1.5; margin-bottom: 1rem;">OWASP security, taint analysis, vulnerability audits. Data protection and compliance.</p>
                <div style="display: flex; flex-wrap: wrap; gap: 0.4rem;">
            ...
            <div class="ecosystem-card" style="background: #0f0f14; border: 1px solid #1f1f2e; border-radius: 12px; padding: 1.5rem; transition: all 0.3s ease;">
                ...
                <p style="color: #9ca3af; font-size: 0.9rem; line-height: 1.5; margin-bottom: 1rem;">Release, CI/CD, marketplace packaging. PHP headers, PHPStan, semantic changelog.</p>
                <div style="display: flex; flex-wrap: wrap; gap: 0.4rem;">
...
<section class="section-creator" style="padding: 3rem 0 4rem; background: #0a0a0f; margin: 0;">
    <div class="container-creator">
        <div class="section-header-creator" style="text-align: center; margin-bottom: 3rem;">
            <p style="text-transform: uppercase; letter-spacing: 2px; font-size: 0.8rem; color: #6b7280; margin-bottom: 0.5rem;">Specialists</p>
            <h2 class="section-title-creator" style="font-size: 1.75rem;">One Expert Per Domain</h2>
        </div>
        ...
        <div class="ecosystem-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem;">
            ...
            <div class="ecosystem-card" style="background: #0f0f14; border: 1px solid #1f1f2e; border-radius: 12px; padding: 1.25rem;">
                ...
                <p style="color: #9ca3af; font-size: 0.8rem; line-height: 1.4; margin-bottom: 0.75rem;">Semver, Git tags, release notes, marketplace packaging.</p>
            ...
            <div class="ecosystem-card" style="background: #0f0f14; border: 1px solid #1f1f2e; border-radius: 12px; padding: 1.25rem;">
                <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.75rem;">
                    ...
                    <div>
                        <span style="font-family: monospace; font-size: 0.65rem; text-transform: uppercase; letter-spacing: 1px; color: #34d399; background: rgba(52, 211, 153, 0.1); padding: 0.15rem 0.4rem; border-radius: 3px;">Translator</span>
                        <h3 style="font-size: 1.1rem; margin: 0.3rem 0 0; color: white;">Camille</h3>
                    </div>
                </div>
                <p style="color: #9ca3af; font-size: 0.8rem; line-height: 1.4; margin-bottom: 0.75rem;">PHP MD5 legacy, XLIFF, back-office wording.</p>
                <div style="display: flex; flex-wrap: wrap; gap: 0.3rem;">
            ...
            <div class="ecosystem-card" style="background: #0f0f14; border: 1px solid #1f1f2e; border-radius: 12px; padding: 1.25rem;">
                ...
                <p style="color: #9ca3af; font-size: 0.8rem; line-height: 1.4; margin-bottom: 0.75rem;">Back-office UX, WCAG 2.1 AA, PrestaShop components.</p>
                <div style="display: flex; flex-wrap: wrap; gap: 0.3rem;">
            ...
            <div class="ecosystem-card" style="background: #0f0f14; border: 1px solid #1f1f2e; border-radius: 12px; padding: 1.25rem;">
                ...
                <p style="color: #9ca3af; font-size: 0.8rem; line-height: 1.4; margin-bottom: 0.75rem;">PS 1.7→8→9, migration scripts, rollback.</p>
                <div style="display: flex; flex-wrap: wrap; gap: 0.3rem;">
...
<section class="section-creator" style="padding: 3rem 0 4rem; background: #0d0d14; margin: 0;">
    <div class="container-creator">
        <div class="section-header-creator" style="text-align: center; margin-bottom: 3rem;">
            ...
            <h2 class="section-title-creator" style="font-size: 1.75rem;">Quality, Memory, Supervision</h2>
        </div>
        ...
        <div class="ecosystem-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;">
            ...
            <div class="ecosystem-card" style="background: #0f0f14; border: 1px solid #1f1f2e; border-radius: 12px; padding: 1.5rem;">
                ...
                <p style="color: #9ca3af; font-size: 0.9rem; line-height: 1.5; margin-bottom: 1rem;">ReAct loop, root cause analysis, fix plan. Fast diagnosis of complex issues.</p>
                <div style="display: flex; flex-wrap: wrap; gap: 0.4rem;">
            ...
            <div class="ecosystem-card" style="background: #0f0f14; border: 1px solid #1f1f2e; border-radius: 12px; padding: 1.5rem;">
                ...
                <p style="color: #9ca3af; font-size: 0.9rem; line-height: 1.5; margin-bottom: 1rem;">QA checklist, regression detection, severity matrix. Pre-production validation.</p>
                <div style="display: flex; flex-wrap: wrap; gap: 0.4rem;">
            ...
            <div class="ecosystem-card" style="background: #0f0f14; border: 1px solid #1f1f2e; border-radius: 12px; padding: 1.5rem;">
                <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                    ...
                    <div>
                        <span style="font-family: monospace; font-size: 0.7rem; text-transform: uppercase; letter-spacing: 1px; color: #a78bfa; background: rgba(167, 139, 250, 0.1); padding: 0.2rem 0.5rem; border-radius: 4px;">Memory</span>
                        <h3 style="font-size: 1.25rem; margin: 0.5rem 0 0; color: white;">Ariane</h3>
                    </div>
                </div>
                <p style="color: #9ca3af; font-size: 0.9rem; line-height: 1.5; margin-bottom: 1rem;">READ, WRITE, LEARN. Architectural decisions, validated patterns, persistent context.</p>
                <div style="display: flex; flex-wrap: wrap; gap: 0.4rem;">
                    <span style="font-size: 0.7rem; padding: 0.25rem 0.5rem; background: #1f1f2e; color: #9ca3af; border-radius: 20px;">Context</span>
...
<section class="section-creator" style="padding: 4rem 0; background: linear-gradient(135deg, #0f0f14 0%, #1a1a2e 100%); margin: 0;">
    <div class="container-creator">
        <div style="text-align: center; max-width: 600px; margin: 0 auto;">
            <h2 class="section-title-creator" style="font-size: 1.75rem; margin-bottom: 1rem;">Ready to Put the Squad to Work?</h2>
            <p style="color: #9ca3af; font-size: 1rem; line-height: 1.6; margin-bottom: 2rem;">
                Book a free exploratory session to evaluate how this orchestration can apply to your PrestaShop context.
            </p>
...
<script type="application/ld+json">
{
  ...
  "name": "PrestaShop AI Agency — Nicolas Dabène",
  "url": "https://nicolas-dabene.fr/en/prestashop-ai-agency/",
  "description": "Squad of specialized AI agents for PrestaShop covering the complete module lifecycle: design, security, packaging, release, migration.",
  "provider": {
    "@type": "Person",
    "name": "Nicolas Dabène",
  ...
  "areaServed": "FR",
  "serviceType": "PrestaShop Module Development with AI Agents"
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is a PrestaShop AI Agency?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A PrestaShop AI Agency is an organization that uses specialized AI agents to develop, audit, and maintain PrestaShop modules. Each agent covers a specific domain: architecture, security, packaging, translation, migration. They work in parallel or sequence depending on task complexity."
      }
    },
    {
      "@type": "Question",
      "name": "Which AI agents make up Nicolas Dabène's PrestaShop squad?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The squad includes 13 agents: Mathieu (builder, PS 8/9 architecture), Sébastien (OWASP security), Élise (packaging and CI/CD), Julien (release manager), Camille (MD5/XLIFF translations), Raphaël (REST API and Admin API), Inès (WCAG 2.1 back-office UX), Thomas (1.7→8→9 migration), Antoine (Command Bus compatibility), Léa (data migration), Victor (ReAct debugger), Sophie (QA gate), Ariane (context memory)."
      }
    },
    {
      "@type": "Question",
      "name": "Do AI agents replace the PrestaShop developer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Specialized AI agents delegate repetitive and contextual work (security, packaging, translation, release), but judgment on architecture choices, technical debt, and business priorities remains human. Nicolas Dabène orchestrates the squad and validates key decisions."
      }
    },
    {
      "@type": "Question",
      "name": "What's the difference between these agents and GitHub Copilot?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "GitHub Copilot completes generic code. Specialized PrestaShop agents know platform-specific patterns, PS 8 vs PS 9 incompatibilities, security rules, marketplace packaging constraints, and MD5 translation conventions. They act autonomously on complete tasks, not line by line."
      }
    }
  ]
}
