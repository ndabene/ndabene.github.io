...
lang: en
faq:
- question: "Will AI really replace my job?"
  answer: "Studies show that 85% of jobs will be transformed, not eliminated. AI becomes a tool that augments your capabilities rather than a replacement. The key is learning to collaborate with these tools."
- question: "Where do I start to learn using AI professionally?"
  answer: "Start simply with ChatGPT or Claude for a repetitive task. For example, writing emails or summarizing documents. 15 minutes a day for 2 weeks is enough to see the difference."
- question: "What skills should I develop to stay relevant?"
  answer: "Focus on what AI doesn't do well: creativity, empathy, critical thinking, and the ability to contextualize. The more you master AI, the more these human skills gain value."
- question: "AI sometimes makes mistakes, how can I trust it?"
  answer: "AI is an assistant, not an oracle. Like with a brilliant intern, you check and validate. Over time, you learn its strengths and limitations, and you work in complementarity."
- question: "How long does it take to become effective with AI?"
  answer: "For the basics: 1 week. To be comfortable: 1 month. To excel: 3-6 months. It's like learning Excel—at first it seems complex, then it becomes natural."
---
...
2. Write as you would speak to a colleague
3. Ask for help on ONE specific task
4. See the result
...
Your human skills × AI augmentation = Your new professional value

### Jobs That Evolve, Not Disappear

**Accountant** → Strategic financial analyst
**Writer** → Multimedia content creator
**HR** → Organizational development coach
**Salesperson** → Solutions consultant
**Developer** → Intelligent systems architect
