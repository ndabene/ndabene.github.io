...
faq:
  ...
  - question: "What's the difference between generative AI and agentic AI?"
    answer: "Generative AI produces text or code in response to a prompt. Agentic AI goes further: an AI agent can read a codebase, modify files, run tests, and operate within an autonomous work sequence."
  - question: "Does agentic AI replace developers?"
    answer: "No. Agentic AI shifts where developer value lies. Raw production tasks are accelerated, but skills in framing, architecture, security, and validation grow in importance."
  - question: "Why isn't a good AI model enough on its own?"
    answer: "Even the best model drifts if context is vague, constraints are implicit, and controls are absent. The quality of an agentic system depends more on how it's framed than on raw model power."
  - question: "How do you measure productivity with agentic AI?"
    answer: "Productivity is no longer measured by speed alone, but by the ability to accelerate without losing control: coherence, maintainability, security, and final deliverable quality."
---
